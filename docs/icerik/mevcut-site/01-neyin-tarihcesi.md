...
tarih: 2018-04-23
goruntulenme: 116895
kapak_gorseli: resimler/icerikler/10.jpg
ozet: "Ney; sulak zeminde, muhtelif uzunluklarda yetişen bitki ve bu bitkiden üretilen nefesli bir çalgıdır."
alindi: 2026-09-14
---

# Neyin Tarihçesi

> **Not:** Mevcut sitedeki metin, 2003 tarihli eski sitedeki metnin kısaltılmış halidir. Son paragraf (ney üstatları ve eserler) yeni sitede **eksik**. Tam hali: [`../arsiv-2003/neyin-tarihcesi.md`](../arsiv-2003/neyin-tarihcesi.md)
...
## Editoryal notlar (yeni site için)

- Orijinalde tek paragraf; okunabilirlik için yukarıda paragraflara bölündü, kelimeler değiştirilmedi.
- Düzeltilecek yazım hataları: `yüzyıllardırr` → `yüzyıllardır`, `bir çok` → `birçok`, `birarada` → `bir arada`, `bayan` → `bayan` (kontrol: “bayan neyzenler”), virgül/boşluk hataları (`ney,bir`, `Türk olsun ,Acem`), çift tırnak yerine kesme işareti (`Hz.Ali”ye` → `Hz. Ali’ye`, `Mevlana”nın` → `Mevlânâ’nın`, `O”na` → `O’na`, `Dilara Ayin-i Şerifi”nin` → `Şerifi’nin`, `II. Mahmud”dan` → `II. Mahmud’dan`).
- Alıntı tırnağı dengesiz: rivayet `“Peygamberimiz ...` ile açılıp `... olmuştur.”` ile kapanıyor, arada `Hz.Ali”ye` hatalı tırnak var.
- Arşivdeki son paragraf (Galata/Yenikapı mevlevihaneleri, ney üstatları, nota mecmuaları) geri eklenmeli.
